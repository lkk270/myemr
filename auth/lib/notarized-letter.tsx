...
import ReactPDF, { Font, Page, Text, Document, StyleSheet, renderToStream } from "@react-pdf/renderer";
import { NextRequest, NextResponse } from "next/server";
// import { ReactPDF } from "@react-pdf";

const NotarizedLetter = () => (
  <Document>
    <Page style={styles.body}>
      ...
      <Text style={styles.text}>
        ...
        se quietó18 y prosiguió su camino, sin llevar otro que aquel que su caballo quería, creyendo que en aquello
...
export async function getBuffer(data: any): Promise<Buffer> {
  const readableStream = await renderToStream(<NotarizedLetter />);
...
// export const buffer = () => {
//   ReactPDF.renderToStream(<NotarizedLetter />);
// };
